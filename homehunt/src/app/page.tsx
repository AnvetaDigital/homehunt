...
export default function Home() {
  return (
    <main className="w-full">
      ...
      {/* FEATURES SECTION */}
      <section className="py-16 px-6 bg-cyan-50 dark:bg-slate-900 transition-colors">
        <h2 className="text-3xl font-bold text-center mb-10 text-gray-900 dark:text-white">
          Why Choose HomeHunt?
        </h2>

        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto text-center">
          <div className="p-6 bg-white dark:bg-slate-800 shadow rounded-lg">
      ...
      {/* CTA SECTION */}
      <section className="py-16 text-center bg-emerald-100 dark:bg-slate-800 transition-colors">
